// This is our miter module.
// It takes the same inputs as the modules it is testing.
module {
  // Assume fsm_mbx_2 and fsm_mbx_3 definitions are present in this file.
  // ... (paste their module definitions here) ...
  hw.module @mbx_fsm_manual(in %in0 : i1, in %in1 : i1, in %in2 : i1, in %in3 : i1, in %in4 : i1, in %in5 : i1, in %in6 : i1, in %in7 : i1, in %in8 : i1, out out0 : i1, out out1 : i1, out out2 : i1, out out3 : i1, out out4 : i1, out out5 : i1, out out6 : i1, out out7 : i1, out out8 : i1, in %clk : !seq.clock, in %rst : i1) {
